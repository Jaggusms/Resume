...
st.markdown("""
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color:#336B6E ;">
  <a class="navbar-brand" href="https://github.com/Jaggusms" target="_self">jagadeesh sanniboina</a>
...
with col1:
    ...
    st.markdown(gif_html, unsafe_allow_html=True)
cols = st.columns([3 if i==12 else 0.5 for i in range(20) ],gap="large")
with cols[0]:
    ...
    with open("source/Jagadeesh_ML_Resume.pdf", "rb") as pdf_file:
        ...
        cols[12].download_button(label=" 📄 Download CV",data=PDFbyte,file_name="souce/Jagadeesh_ML_Resume.pdf",mime="application/octet-stream")
