...
with tab1s[0]:
    ...
    with col2:
        ...
        with open("source/JAGADEESH_SANNIBOINA.pdf", "rb") as pdf_file:
...
with tab1s[2]:
    ...
    with cols[0]:
        ...
        st.markdown("&ensp; &nbsp;:black_right_pointing_triangle_with_double_vertical_bar:  Technologies Used: RAG (Retrieval-Augmented Generation) model, all-mpnet-base-v2, GPT2 model.")
        ...
        st.markdown("&ensp; &nbsp;:black_right_pointing_triangle_with_double_vertical_bar:  Created detailed context documents to store the collected information. Embedding and Vector Selection: Utilized all-mpnet-base-v2 to embed privacy-related information into vector representations.")
        ...
        st.markdown("&ensp; &nbsp;:black_right_pointing_triangle_with_double_vertical_bar:  Model Integration: Integrated the selected vectors with the GPT2 model.")
